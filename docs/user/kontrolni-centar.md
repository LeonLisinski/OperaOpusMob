...
App PIN je zasebna šifra po aplikaciji (npr. za CRM ili Nalozi). Unesite PIN i pritisnite **Otključaj**. Nakon uspjeha otvara se popis modula.

::: tip
App PIN se razlikuje od Core PIN-a. Core PIN aktivira cijeli uređaj; App PIN otključava pojedinu aplikaciju.
:::
...
Ikona zupčanika gore desno otvara **Postavke** (v. [Postavke](./postavke)).
