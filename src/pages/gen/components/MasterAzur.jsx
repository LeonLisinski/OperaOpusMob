...
import { saveGla, selectDocs, setItemDataEdit, setItemDataEditValues } from '../store';
        ...
        <>
            ...
            <IonModal isOpen={props.showModal} ref={modal} onWillDismiss={(ev) => onWillDismiss(ev)}>
                ...
                <IonContent className="searchForm ion-padding">
                    {renderForm()}
                    <Search app='crm' sp={layouts.queries?.gla?.sifarnici?.sp} entity={searchModalProps.entity} showModal={searchModalProps.showModal} type={searchModalProps.type} onClick={onSearchModalConfirm} onHideModal={onHideModal} debaunce={searchModalProps.debaunce} parentId={searchModalProps.parentId}></Search>
                </IonContent>
