...
const Tab2 = () => {
  ...
  const goBack = () => {
    router.push('/servis/dnevniizvjestaj', 'none');
  }
  ...
  return (
    <IonPage>
      ...
      <IonContent fullscreen className="ion-padding" >
        ...
        <IonTextarea placeholder="Komentar" autoGrow={true} style={{ border: '1px solid #ccc', minHeight: 150 }} ref={commentRef} value={listItem?.komentar}>
