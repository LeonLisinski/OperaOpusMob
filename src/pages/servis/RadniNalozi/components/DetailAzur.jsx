    ...
    <>
      <IonModal isOpen={props.showModal} ref={modal} onWillDismiss={(ev) => onWillDismiss(ev)}>
        ...
        <IonContent className="ion-padding">
          ...
          <IonButton className='ion-text-wrap' style={{ height: 70 }} onClick={() => handleShowModal('USL')} expand="block" fill={artikl.id ? 'solid' : 'outline'}>
            {artikl.name}
          </IonButton>
...
export default memo(DetailAzur);
